...
func (_m *Service) TestConnection(ctx context.Context, params connections.TestConnection) error {
	ret := _m.Called(ctx, params)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, connections.TestConnection) error); ok {
		r0 = rf(ctx, params)
	} else {
		r0 = ret.Error(0)
	}
