...
func (_m *Service) DeleteConversation(ctx context.Context, userID int32, conversationID int64) error {
...
func (_m *Service) SendMessageWithProgress(ctx context.Context, params chat.SendMessageParams, progress chat.SendMessageProgressHandler) (*chat.AssistantTurn, error) {
...
func (_m *Service) TestProviderConfig(ctx context.Context, params internalchat.TestProviderConfigParams) (*internalchat.TestProviderConfigResult, error) {
	ret := _m.Called(ctx, params)
