...
type preloadCounts struct {
	ChatConversation  chatConversationCountPreloader
	ChatMessage       chatMessageCountPreloader
	Connection        connectionCountPreloader
	LLMProviderConfig llmProviderConfigCountPreloader
	SchemaSnapshot    schemaSnapshotCountPreloader
	User              userCountPreloader
}

func getPreloadCount() preloadCounts {
	return preloadCounts{
		ChatConversation:  buildChatConversationCountPreloader(),
		ChatMessage:       buildChatMessageCountPreloader(),
		Connection:        buildConnectionCountPreloader(),
		LLMProviderConfig: buildLLMProviderConfigCountPreloader(),
		SchemaSnapshot:    buildSchemaSnapshotCountPreloader(),
		User:              buildUserCountPreloader(),
	}
}

type thenLoadCounts[Q orm.Loadable] struct {
	ChatConversation  chatConversationCountThenLoader[Q]
	ChatMessage       chatMessageCountThenLoader[Q]
	Connection        connectionCountThenLoader[Q]
	LLMProviderConfig llmProviderConfigCountThenLoader[Q]
	SchemaSnapshot    schemaSnapshotCountThenLoader[Q]
	User              userCountThenLoader[Q]
}

func getThenLoadCount[Q orm.Loadable]() thenLoadCounts[Q] {
	return thenLoadCounts[Q]{
		ChatConversation:  buildChatConversationCountThenLoader[Q](),
		ChatMessage:       buildChatMessageCountThenLoader[Q](),
		Connection:        buildConnectionCountThenLoader[Q](),
		LLMProviderConfig: buildLLMProviderConfigCountThenLoader[Q](),
		SchemaSnapshot:    buildSchemaSnapshotCountThenLoader[Q](),
