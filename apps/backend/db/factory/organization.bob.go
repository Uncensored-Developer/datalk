...
// Set the model columns to this value
func (m organizationMods) CreatedAt(val string) OrganizationMod {
	return OrganizationModFunc(func(_ context.Context, o *OrganizationTemplate) {
...
// Set the Column from the function
func (m organizationMods) CreatedAtFunc(f func() string) OrganizationMod {
	return OrganizationModFunc(func(_ context.Context, o *OrganizationTemplate) {
		o.CreatedAt = f
	})
}
...
// Set the model columns to this value
func (m organizationMods) Singleton(val int64) OrganizationMod {
	return OrganizationModFunc(func(_ context.Context, o *OrganizationTemplate) {
		o.Singleton = func() int64 { return val }
	})
}

// Set the Column from the function
func (m organizationMods) SingletonFunc(f func() int64) OrganizationMod {
	return OrganizationModFunc(func(_ context.Context, o *OrganizationTemplate) {
		o.Singleton = f
	})
}
