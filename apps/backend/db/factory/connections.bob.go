...
func (o *ConnectionTemplate) Create(ctx context.Context, exec bob.Executor) (*models.Connection, error) {
	...
	if o.r.User == nil {
		if parentModel, found := mInCreation["users:connections:connections.connections_user_id_fkey"]; found {
	...
	newMInCreation["connections:chat_conversations:chat_conversations.chat_conversations_connection_id_fkey"] = m
	newMInCreation["connections:chat_message_executions:chat_message_executions.chat_message_executions_connection_id_fkey"] = m
	newMInCreation["connections:connection_access:connection_access.connection_access_connection_id_fkey"] = m
	newMInCreation["connections:schema_chunks:schema_chunks.schema_chunks_connection_id_fkey"] = m
	newMInCreation["connections:schema_snapshots:schema_snapshots.schema_snapshots_connection_id_fkey"] = m
...
func (m connectionMods) AddExistingConnectionAccesses(existingModels ...*models.ConnectionAccess) ConnectionMod {
	return ConnectionModFunc(func(ctx context.Context, o *ConnectionTemplate) {
		for _, em := range existingModels {
			o.r.ConnectionAccesses = append(o.r.ConnectionAccesses, &connectionRConnectionAccessesR{
				o: o.f.fromExistingConnectionAccess(ctx, em),
			})
		}
	})
}
