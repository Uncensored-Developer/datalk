...
var (
	...
	connectionAccessRelConnectionCtx        = newContextual[bool]("connection_access.connections.fk_connection_access_0")
	connectionAccessRelUserCtx              = newContextual[bool]("connection_access.users.fk_connection_access_1")
