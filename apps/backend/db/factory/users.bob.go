...
func (o UserTemplate) BuildSetter() *models.UserSetter {
	...
	if o.MustChangePassword != nil {
		val := o.MustChangePassword()
		m.MustChangePassword = omit.From(val)
	}
	if o.UpdatedAt != nil {
		val := o.UpdatedAt()
...
func (o UserTemplate) Build() *models.User {
	...
	if o.MustChangePassword != nil {
		m.MustChangePassword = o.MustChangePassword()
	}
	if o.UpdatedAt != nil {
	...
	if !isRefreshTokensDone && o.r.RefreshTokens != nil {
		...
		for _, r := range o.r.RefreshTokens {
			if r.o.alreadyPersisted {
				...
				err = m.AttachRefreshTokens(ctx, exec, rel3...)
				if err != nil {
					return err
				}
			}
...
func (o *UserTemplate) Create(ctx context.Context, exec bob.Executor) (*models.User, error) {
	...
	newMInCreation["users:chat_conversations:chat_conversations.chat_conversations_user_id_fkey"] = m
	newMInCreation["users:connection_access:connection_access.connection_access_user_id_fkey"] = m
	newMInCreation["users:connections:connections.connections_user_id_fkey"] = m
	newMInCreation["users:refresh_tokens:refresh_tokens.refresh_tokens_user_id_fkey"] = m
...
func (m userMods) RandomizeAllColumns(f *faker.Faker) UserMod {
	return UserModSlice{
		...
		UserMods.RandomMustChangePassword(f),
...
// Set the model columns to this value
func (m userMods) MustChangePassword(val bool) UserMod {
	return UserModFunc(func(_ context.Context, o *UserTemplate) {
		o.MustChangePassword = func() bool { return val }
	})
}

// Set the Column from the function
func (m userMods) MustChangePasswordFunc(f func() bool) UserMod {
	return UserModFunc(func(_ context.Context, o *UserTemplate) {
		o.MustChangePassword = f
	})
}

// Clear any values for the column
func (m userMods) UnsetMustChangePassword() UserMod {
	return UserModFunc(func(_ context.Context, o *UserTemplate) {
...
// Generates a random value for the column using the given faker
// if faker is nil, a default faker is used
func (m userMods) RandomMustChangePassword(f *faker.Faker) UserMod {
	return UserModFunc(func(_ context.Context, o *UserTemplate) {
		o.MustChangePassword = func() bool {
			return random_bool(f)
		}
	})
}
...
func (m userMods) AddExistingRefreshTokens(existingModels ...*models.RefreshToken) UserMod {
	return UserModFunc(func(ctx context.Context, o *UserTemplate) {
		for _, em := range existingModels {
			o.r.RefreshTokens = append(o.r.RefreshTokens, &userRRefreshTokensR{
				o: o.f.fromExistingRefreshToken(ctx, em),
			})
		}
	})
}
